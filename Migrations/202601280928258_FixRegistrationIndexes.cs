namespace KeeleSystem.Migrations
{
    ...
    public partial class FixRegistrationIndexes : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Staatus = c.String(nullable: false, maxLength: 20),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Trainings", t => t.TrainingId, cascadeDelete: true)
                .ForeignKey("dbo.AspNetUsers", t => t.ApplicationUserId, cascadeDelete: true)
                .Index(t => new { t.TrainingId, t.ApplicationUserId }, unique: true, name: "IX_Training_User");
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Registrations", "IX_Training_User");
